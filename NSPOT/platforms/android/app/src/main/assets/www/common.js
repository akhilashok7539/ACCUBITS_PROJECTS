...
const endPoints = {
    ...
    Create_galleryItem: 'institute/gallery/create/',
    Create_bankDetails: 'institute/bank-details/create/',
    Create_aptitudeTest: 'institute/aptitude-tests/create/',
    Create_aptitudeQuestion: 'institute/aptitude-tests/',
    UploadProfilePhotoFile: 'institute/UploadProfilePhotoFile/',
    Create_course: 'institute/course/create/',
    Create_courseFee: 'institute/course/fees/create/',
    ...
    Get_subscriptionOrderInstitute: 'payment/subscription/institute/',
    //application form related
    Create_additionalField: 'applicationForm/additionalFields/create/',
    Remove_additionalField: 'applicationForm/additionalFields/remove/',
    Create_removedField: 'applicationForm/removedFields/create/',
    Remove_removedField: 'applicationForm/removedFields/remove/',
    Get_additionalField: 'applicationForm/getAdditional/',
    Get_removedField: 'applicationForm/getRemoved/',
    Get_applications: 'applicationForm/applications',
    Update_applicationForm: 'applicationForm/applications/update',
    GetInstituteInfo: 'institute/',
    Get_socialMedia: 'institute/social-media/',
    Get_virtualTour: 'institute/virtual-tour/',
    Get_highlights: 'institute/highlights/',
    Get_boardOfCouncil: 'institute/board-of-council/',
    Get_gallery: 'institute/gallery/',
    Get_bankDetails: 'institute/bank-details/',
    Get_aptitudeTests: 'institute/aptitude-tests/',
    Get_aptitudeTests_questions: 'institute/aptitude-tests/',
    Get_admissionOfficer: 'admission-officer/',
    Get_admissionOfficerByInstitute: 'admission-officer/getByInstitute/',
    Get_plans: 'plans/byInstituteType/',
    // Common endpoints
    instituteTypes: 'institute-types',
    Get_academicLevels: 'academic-level/',
    Get_licenseAuthorities: 'license-issue-authority/',
    Get_academicLevel_Courses: 'academic-level/courses/',
    ...
    Get_courseStream_specialization: 'course-stream/specialization/',
    Get_notifications: 'notifications/',
    Update_notifications: 'notifications/update',
    Calculate_NspotFee: 'institute/course/calculate-nspot-fees/',
    Get_courses: 'institute/course/',
    Update_course: 'institute/course/update/',
