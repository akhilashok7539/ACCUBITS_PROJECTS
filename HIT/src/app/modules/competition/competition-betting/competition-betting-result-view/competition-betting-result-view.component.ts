...
@Component({
  selector: 'app-competition-betting-result-view',
  templateUrl: './competition-betting-result-view.component.html',
  styleUrls: ['./competition-betting-result-view.component.scss']
})
export class CompetitionBettingResultViewComponent implements OnInit {
